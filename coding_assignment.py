...
def solution(dict, input):

  for i in range(0, len(input)):
    find_palindromes(dict, input, i - 1, i + 1)       #find palindromes with odd length 
    find_palindromes(dict, input, i, i + 1)           #find palindromes with even length
...
solution(palindromes, input_string)                                           #***comment this section for testing***
